...
class GatewayConfigFile(object):
    ...
    def __init__(self):
        self.zbs_node = None  # type: Optional[str]
        ...
        self.gateway_zbs_address_secret = None  # type: Optional[KeyPair]
