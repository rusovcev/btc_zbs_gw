...
from zbs_gateway.common import DuplicateMappingError
import gevent.lock
...
class MapStorage(ABC):
    ...
    def coin_address_exists(self, coin_address: str) -> bool:
        ...
        """
        return self.get_zbs_address_by_coin_address(coin_address) is not None
    ...
    @abstractmethod
    def get_coin_address_by_zbs_address(self, coin_address: str) -> Optional[str]:
        """
    ...
    def zbs_address_exists(self, zbs_address: str) -> bool:
        """
        Tests if the given Waves address exists.
        This method may be overwritten if a more performant variant exists.
        """
        return self.get_coin_address_by_zbs_address(zbs_address) is not None
    ...
    def safely_save_mapping(self, mapping: MappingEntry):
        ...
        try:
            if self.zbs_address_exists(mapping.zbs_address) or self.coin_address_exists(mapping.coin_address):
