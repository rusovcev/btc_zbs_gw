...
"""
from zbs_gateway.common import Injectable, KEY_VALUE_STORAGE_COLLECTION
from zbs_gateway.model import PollingState
from zbs_gateway.serializer import PollingStateSerializer
...
class MongoKeyValueStorageImpl(KeyValueStorage):
    ...
    @method_doc_inherit
    def set_last_checked_zbs_block_height(self, block_height: int) -> None:
        self._set_value(MongoKeyValueStorageImpl._ZBS_BLOCK_HEIGHT_KEY, block_height)

    @method_doc_inherit
    def get_last_checked_zbs_block_height(self) -> Optional[int]:
        return self._get_value(MongoKeyValueStorageImpl._ZBS_BLOCK_HEIGHT_KEY)
    ...
    def set_zbs_polling_state(self, polling_state: PollingState) -> None:
        self._set_value(MongoKeyValueStorageImpl._ZBS_POLLING_STATE_KEY,
    ...
    def get_zbs_polling_state(self) -> Optional[PollingState]:
        data = self._get_value(MongoKeyValueStorageImpl._ZBS_POLLING_STATE_KEY)
