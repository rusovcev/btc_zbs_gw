...
from zbs_gateway.common import map_array, Injectable
from zbs_gateway.service import AttemptListConverterService

from zbs_gateway.model import AttemptListTrigger, TransactionAttemptList, AttemptListQuery
...
class GatewayControllerConverterProxyImpl(GatewayController):
    ...
    def validate_zbs_address(self, address: str) -> bool:
        return self._gateway_controller.validate_zbs_address(address)
    ...
    def create_address(self, zbs_address: str) -> str:
        return self._gateway_controller.create_address(zbs_address)
