...
ZBS_NODE = InjectionToken('ZBS_NODE', str)
COIN_NODE = InjectionToken('COIN_NODE', str)
ZBS_ASSET_ID = InjectionToken('ZBS_ASSET_ID', str)
ZBS_CHAIN = InjectionToken('ZBS_CHAIN', str)
...
ZBS_TRANSACTION_WEB_LINK = InjectionToken('ZBS_TRANSACTION_WEB_LINK', str)
COIN_ADDRESS_WEB_LINK = InjectionToken('COIN_ADDRESS_WEB_LINK', str)
ZBS_ADDRESS_WEB_LINK = InjectionToken('ZBS_ADDRESS_WEB_LINK', str)
ATTEMPT_LIST_MAX_COMPLETION_TRIES = InjectionToken('ATTEMPT_LIST_MAX_COMPLETION_TRIES', int)
GATEWAY_ZBS_ADDRESS_SECRET = InjectionToken('GATEWAY_ZBS_ADDRESS_SECRET', KeyPair)
GATEWAY_ZBS_ADDRESS = InjectionToken('GATEWAY_ZBS_ADDRESS', str)
...
GATEWAY_ZBSPY_ADDRESS = InjectionToken('GATEWAY_ZBSPY_ADDRESS', pywaves.Address)
COIN_CHAIN_QUERY_SERVICE_CONVERTER_PROXY = InjectionToken('COIN_CHAIN_QUERY_SERVICE_CONVERTER_PROXY')
ZBS_CHAIN_QUERY_SERVICE_CONVERTER_PROXY = InjectionToken('ZBS_CHAIN_QUERY_SERVICE_CONVERTER_PROXY')
...
ZBS_MAX_HANDLE_TRANSACTION_TRIES = InjectionToken('ZBS_MAX_HANDLE_TRANSACTION_TRIES', int)
ZBS_LAST_BLOCK_DISTANCE = InjectionToken('ZBS_LAST_BLOCK_DISTANCE', int)
...
ZBS_CHAIN_ID = InjectionToken('ZBS_CHAIN_ID', str)
