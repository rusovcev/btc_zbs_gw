...
from zbs_gateway.common import Injectable, NUM_ATTEMPT_LIST_WORKERS, GATEWAY_HOST, GATEWAY_PORT
...
from .token import COIN_TRANSACTION_POLLING_SERVICE, ZBS_TRANSACTION_POLLING_SERVICE


@Injectable(deps=[
    GatewayValidationService, Logger, COIN_TRANSACTION_POLLING_SERVICE, ZBS_TRANSACTION_POLLING_SERVICE,
...
class GatewayApplicationService(object):
    ...
    def __init__(self, validation_service: GatewayValidationService, logger: Logger,
                 ...
                 zbs_transaction_polling_service: TransactionPollingService, num_attempt_list_workers: int,
        ...
        self._zbs_transaction_polling_service = zbs_transaction_polling_service
    ...
    def run(self) -> None:
        ...
        gevent.signal(signal.SIGINT, self._zbs_transaction_polling_service.cancel)

        task_group.start(self._coin_transaction_polling_service)
        task_group.start(self._zbs_transaction_polling_service)
