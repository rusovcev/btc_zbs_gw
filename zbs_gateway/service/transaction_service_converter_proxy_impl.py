...
from zbs_gateway.model import Transaction, TransactionAttempt
from zbs_gateway.service.token import COIN_TRANSACTION_SERVICE, COIN_INTEGER_CONVERTER_SERVICE, \
...
from .token import COIN_TRANSACTION_SERVICE_CONVERTER_PROXY, ZBS_TRANSACTION_SERVICE_CONVERTER_PROXY
...
@Injectable(
    ZBS_TRANSACTION_SERVICE_CONVERTER_PROXY,
