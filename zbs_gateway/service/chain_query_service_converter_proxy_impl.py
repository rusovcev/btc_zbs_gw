...
from zbs_gateway.common import map_array, Injectable, COIN_CHAIN_QUERY_SERVICE_CONVERTER_PROXY, \
    ZBS_CHAIN_QUERY_SERVICE_CONVERTER_PROXY
from zbs_gateway.model import Transaction

from .chain_query_service import ChainQueryService
from .integer_converter_service import IntegerConverterService
from .token import COIN_CHAIN_QUERY_SERVICE, COIN_INTEGER_CONVERTER_SERVICE, ASSET_INTEGER_CONVERTER_SERVICE, ZBS_CHAIN_QUERY_SERVICE


@Injectable(COIN_CHAIN_QUERY_SERVICE_CONVERTER_PROXY, deps=[COIN_CHAIN_QUERY_SERVICE, COIN_INTEGER_CONVERTER_SERVICE])
@Injectable(
    ZBS_CHAIN_QUERY_SERVICE_CONVERTER_PROXY, deps=[ZBS_CHAIN_QUERY_SERVICE, ASSET_INTEGER_CONVERTER_SERVICE])
