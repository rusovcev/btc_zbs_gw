...
from zbs_gateway.model import TransactionAttempt, Transaction
from .token import COIN_TRANSACTION_SERVICE_CONVERTER_PROXY, ZBS_TRANSACTION_SERVICE_CONVERTER_PROXY

from .transaction_service import TransactionService


@Injectable(deps=[COIN_TRANSACTION_SERVICE_CONVERTER_PROXY, ZBS_TRANSACTION_SERVICE_CONVERTER_PROXY])
