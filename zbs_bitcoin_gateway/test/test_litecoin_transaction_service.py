...
from waves_litecoin_gateway.lib import LitecoinTransactionService, BitcoinChainQueryService
...
class LitecoinTransactionServiceSpec(unittest.TestCase):
    def setUp(self):
        ...
        self._transaction_service = LitecoinTransactionService(
            btc_proxy=cast(AuthServiceProxy, self._ltc_proxy),
            btc_chain_query_service=cast(BitcoinChainQueryService, self._ltc_chain_query_service))
